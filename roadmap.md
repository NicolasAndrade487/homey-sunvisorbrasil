# Portal de Documentos SVB

- [x] Backend em nuvem (banco, login, armazenamento privado)
- [x] Login/cadastro por email da empresa + Google
- [x] Catálogo compartilhado com busca e filtros por categoria
